...
& $GEM_CMD install protobuf:3.6 google-protobuf:3.5.1 grpc:1.8.3 googleapis-common-protos:1.3.4 fluent-plugin-google-cloud:0.7.2 --no-ri --no-rdoc --no-document
